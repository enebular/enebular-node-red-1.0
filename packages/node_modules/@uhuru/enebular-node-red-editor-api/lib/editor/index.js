...
var needsPermission;
var runtimeAPI;
var log = require("@uhuru/enebular-node-red-util").log;
var i18n = require("@uhuru/enebular-node-red-util").i18n;
...
module.exports = {
    ...
    start: function() {
        var catalogPath = path.resolve(path.join(path.dirname(require.resolve("@uhuru/enebular-node-red-editor-client")),"locales"));
