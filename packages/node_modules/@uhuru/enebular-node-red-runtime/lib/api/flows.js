...
var api = module.exports = {
    ...
    * @param {Object} opts.req - the request to log (optional)
    * @param {Object} opts.screenshot - the screenshot of a flow
    * @return {Promise<Flows>} - the active flow configuration
    * @memberof @node-red/runtime_flows
    */
    setFlows: function(opts) {
        return new Promise(function(resolve,reject) {
            ...
            if (deploymentType === 'reload') {
                ...
                apiPromise = runtime.nodes.setFlows(flows.flows,flows.credentials,deploymentType, null, null, screenshot);
            }
