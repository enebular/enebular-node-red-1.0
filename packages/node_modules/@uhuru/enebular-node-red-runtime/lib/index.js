...
var redUtil = require("@uhuru/enebular-node-red-util");
var log = redUtil.log;
 ...
 * @param {AdminAPI} adminApi - an instance of @uhuru/enebular-node-red-editor-api. <B>TODO</B>: This needs to be
 *                              better abstracted.
 * @memberof @uhuru/enebular-node-red-runtime
 */
...
var runtime = {
    ...
    library: library,
    exec: exec,
    util: require("@uhuru/enebular-node-red-util").util,
 ...
 *
 * @namespace @uhuru/enebular-node-red-runtime
 */
module.exports = {
    init: init,
    start: start,
    ...
    /**
    * @memberof @uhuru/enebular-node-red-runtime
    * @mixes @uhuru/enebular-node-red-runtime_comms
    */
    comms: externalAPI.comms,
    /**
    * @memberof @uhuru/enebular-node-red-runtime
    * @mixes @uhuru/enebular-node-red-runtime_flows
    */
    flows: externalAPI.flows,
    /**
    * @memberof @uhuru/enebular-node-red-runtime
    * @mixes @uhuru/enebular-node-red-runtime_library
    */
    library: externalAPI.library,
    /**
    * @memberof @uhuru/enebular-node-red-runtime
    * @mixes @uhuru/enebular-node-red-runtime_nodes
    */
    nodes: externalAPI.nodes,
    /**
    * @memberof @uhuru/enebular-node-red-runtime
    * @mixes @uhuru/enebular-node-red-runtime_settings
    */
    settings: externalAPI.settings,
    /**
    * @memberof @uhuru/enebular-node-red-runtime
    * @mixes @uhuru/enebular-node-red-runtime_projects
    */
    projects: externalAPI.projects,
    /**
    * @memberof @uhuru/enebular-node-red-runtime
    * @mixes @uhuru/enebular-node-red-runtime_context
    */
