...
var runtime = require("@uhuru/enebular-node-red-runtime");
var redUtil = require("@uhuru/enebular-node-red-util");

var api = require("@uhuru/enebular-node-red-editor-api");
...
module.exports = {
    ...
    init: function(httpServer, userSettings) {
        ...
        if (!userSettings.coreNodesDir) {
            userSettings.coreNodesDir = path.dirname(require.resolve("@uhuru/enebular-node-red-nodes"))
        }
    ...
    /**
     * Logging utilities
     * @see @uhuru/enebular-node-red-util_log
     * @memberof node-red
     */
    log: redUtil.log,
    ...
    /**
     * General utilities
     * @see @uhuru/enebular-node-red-util_util
     * @memberof node-red
     */
    util: redUtil.util,
     ...
     * @see @uhuru/enebular-node-red-runtime_events
     * @memberof node-red
     */
    ...
    /**
     * The runtime api
     * @see @uhuru/enebular-node-red-runtime
     * @memberof node-red
     */
    runtime: runtime,
     ...
     * @see @uhuru/enebular-node-red-editor-api_auth
     * @memberof node-red
     */
    auth: api.auth
};
