...
//
// 1. Create a copy of packages/node_modules/@uhuru/enebular-node-red-editor-client/src/sass/colors.scss
...
let colorsFile = fs.readFileSync(
  path.join(
    __dirname,
    "../packages/node_modules/@uhuru/enebular-node-red-editor-client/src/sass/colors.scss"
  ),
  "utf-8"
);
let updatedColors = [];
...
while ((match = ruleRegex.exec(colorsFile)) !== null) {
  updatedColors.push(
    match[1] + ": " + (customColors[match[1]] || match[2]) + ";"
  );
}
...
const result = sass.renderSync({
  ...
  importer: function (url, prev, done) {
    ...
    return {
      file:
        "../packages/node_modules/@uhuru/enebular-node-red-editor-client/src/sass/" +
        url +
        ".scss",
    };
  },
