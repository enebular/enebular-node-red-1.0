...
var editorApi = NR_TEST_UTILS.require("@uhuru/enebular-node-red-editor-api/lib/editor");
var comms = NR_TEST_UTILS.require("@uhuru/enebular-node-red-editor-api/lib/editor/comms");
var info = NR_TEST_UTILS.require("@uhuru/enebular-node-red-editor-api/lib/editor/settings");
var auth = NR_TEST_UTILS.require("@uhuru/enebular-node-red-editor-api/lib/auth");

var log = NR_TEST_UTILS.require("@uhuru/enebular-node-red-util").log;
    ...
    describe("enables the editor", function() {
        ...
        before(function() {
            ...
            mockList.forEach(function(m) {
                sinon.stub(NR_TEST_UTILS.require("@uhuru/enebular-node-red-editor-api/lib/editor/"+m),"init",function(){});
            });
            sinon.stub(NR_TEST_UTILS.require("@uhuru/enebular-node-red-editor-api/lib/editor/theme"),"app",function(){ return express()});
        });
        after(function() {
            mockList.forEach(function(m) {
                NR_TEST_UTILS.require("@uhuru/enebular-node-red-editor-api/lib/editor/"+m).init.restore();
            })
            NR_TEST_UTILS.require("@uhuru/enebular-node-red-editor-api/lib/editor/theme").app.restore();
