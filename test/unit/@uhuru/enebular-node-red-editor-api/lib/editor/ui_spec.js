...
var ui = NR_TEST_UTILS.require("@uhuru/enebular-node-red-editor-api/lib/editor/ui");
...
describe("api/editor/ui", function() {
            ...
            nodes: {
                getIcon: function(opts) {
                    return new Promise(function(resolve,reject) {
                        fs.readFile(NR_TEST_UTILS.resolve("@uhuru/enebular-node-red-editor-client/src/images/icons/arrow-in.svg"), function(err,data) {
                            resolve(data);
                        })
                    });
                }
    ...
    describe("icon handler", function() {
        ...
        it('returns the requested icon', function(done) {
            var defaultIcon = fs.readFileSync(NR_TEST_UTILS.resolve("@uhuru/enebular-node-red-editor-client/src/images/icons/arrow-in.svg"));
            request(app)
