...
var i18n = NR_TEST_UTILS.require("@uhuru/enebular-node-red-util").i18n;
...
describe("red/nodes/registry/localfilesystem",function() {
    ...
    describe("#getNodeFiles",function() {
        ...
        it("Finds nodes in settings.nodesDir (string,relative path)",function(done) {
            var relativeUserDir = path.join("test","unit","@uhuru","enebular-node-red-registry","lib","resources","userDir");
