...
var index = NR_TEST_UTILS.require("@uhuru/enebular-node-red-runtime/lib/nodes/index");
var flows = NR_TEST_UTILS.require("@uhuru/enebular-node-red-runtime/lib/nodes/flows");
var registry = NR_TEST_UTILS.require("@uhuru/enebular-node-red-registry")
var Node = NR_TEST_UTILS.require("@uhuru/enebular-node-red-runtime/lib/nodes/Node");
...
describe("red/nodes/index", function() {
    ...
    describe("registerType", function() {
        ...
        describe("register credentials definition", function() {
            ...
            var app = express();
            var runtime = NR_TEST_UTILS.require("@uhuru/enebular-node-red-runtime");
            var credentials = NR_TEST_UTILS.require("@uhuru/enebular-node-red-runtime/lib/nodes/credentials");
            var localfilesystem = NR_TEST_UTILS.require("@uhuru/enebular-node-red-runtime/lib/storage/localfilesystem");
            var log = NR_TEST_UTILS.require("@uhuru/enebular-node-red-util").log;
            var RED = NR_TEST_UTILS.require("@uhuru/enebular-node-red/lib/red.js");
